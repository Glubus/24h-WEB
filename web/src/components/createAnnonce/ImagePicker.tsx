...
export function ImagePicker({ imagePreviews, onImagesChange }: ImagePickerProps) {
  return (
      ...
      {imagePreviews.length === 0 ? null : (
        <div className="mt-3 grid gap-3 sm:grid-cols-2 md:grid-cols-3">
          {imagePreviews.map((image) => (
            <div className="overflow-hidden rounded-lg border border-base-300 bg-base-100" key={image.url}>
