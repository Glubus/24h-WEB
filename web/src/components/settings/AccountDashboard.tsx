      ...
      <div className="mt-6 rounded-lg border border-base-300 bg-base-100 p-5">
        ...
        <div className="mt-6 h-72 w-full">
          <ResponsiveContainer height="100%" width="100%">
            <AreaChart data={chartData} margin={{ bottom: 0, left: -24, right: 8, top: 8 }}>
              <defs>
                <linearGradient id="salesGradient" x1="0" x2="0" y1="0" y2="1">
                  <stop offset="5%" stopColor="oklch(var(--p))" stopOpacity={0.35} />
                  <stop offset="95%" stopColor="oklch(var(--p))" stopOpacity={0.03} />
                </linearGradient>
              </defs>
              <CartesianGrid stroke="oklch(var(--bc) / 0.10)" strokeDasharray="3 3" vertical={false} />
              <XAxis
                axisLine={false}
                dataKey="label"
